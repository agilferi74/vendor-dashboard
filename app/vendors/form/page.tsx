...
function VendorFormContent() {
  ...
  const handleDelete = async () => {
    if (vendorId && confirm("Are you sure you want to delete this vendor?")) {
      setLoading(true)
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8">
            <div className="space-y-6 sm:space-y-8">
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Basic Information</h2>
              ...
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">PIC Komersial</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div>
              ...
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">PIC Teknikal</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div>
